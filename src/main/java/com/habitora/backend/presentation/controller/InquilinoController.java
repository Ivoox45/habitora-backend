...
public class InquilinoController {
    ...
    @PostMapping
    @Operation(
            summary = "Crear un inquilino en una propiedad",
            description = "Crea un nuevo inquilino dentro de la propiedad seleccionada."
    )
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Inquilino creado",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = InquilinoResponseDto.class))),
    ...
    @GetMapping
    @Operation(
            summary = "Listar inquilinos de una propiedad",
            description = """
    ...
    @ApiResponse(responseCode = "200",
            ...
            content = @Content(mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = InquilinoListResponseDto.class))))
    ...
    @Operation(
            ...
            description = "Obtiene los detalles del inquilino dentro de la propiedad seleccionada."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Modifica los datos del inquilino dentro de la propiedad."
    )
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Inquilino actualizado",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = InquilinoResponseDto.class))),
            @ApiResponse(responseCode = "400", description = "Datos inválidos", content = @Content),
            @ApiResponse(responseCode = "404", description = "Inquilino no encontrado", content = @Content)
    ...
    @Operation(
            ...
            description = "Elimina permanentemente el registro del inquilino en la propiedad."
    )
    @ApiResponses({
    ...
    @GetMapping("/search")
    @Operation(
            summary = "Buscar inquilinos",
            description = "Busca inquilinos por nombre o DNI (búsqueda parcial)."
    )
    @ApiResponse(responseCode = "200",
